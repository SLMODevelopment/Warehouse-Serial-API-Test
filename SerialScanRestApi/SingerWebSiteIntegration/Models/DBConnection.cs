    ...
    public class DBConnection
    {
        ...
        public OracleConnection GetConnection()
        {
            ...
            try
            {
                ...
                //Test
                string conString = "Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=172.16.2.140)(PORT=1547)))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=testpdb)));User ID=IFSAPP;Password=siN$Py$T0325;";
